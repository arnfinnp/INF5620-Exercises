...
# Note: u_nodal_values.array() returns a copy of the data
new_u_array = u_nodal_values.array()
print 'u_nodal_values.array() returns a copy of the data:',
print id(new_u_array) != id(u_array)  # two different objects?
